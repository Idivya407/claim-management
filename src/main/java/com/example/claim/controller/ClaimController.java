...
public class ClaimController {
	...
	@Operation(summary = "Submit a new claim", description = "This API allows a user to submit a claim with amount and details.")
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Claim submitted successfully"),
	...
	@PutMapping("/{claimId}")
	public Map<String, Object> updateClaim(@PathVariable Long claimId, @RequestBody Claim updatedClaim) {
